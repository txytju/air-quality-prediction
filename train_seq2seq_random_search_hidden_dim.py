...
for hidden_dim in hidden_dims : 
    ...
    for name in saved_iteractions :
        ...
        with tf.Session() as sess:
            ...
            saver = rnn_model['saver']().restore(sess,  os.path.join('./seq2seq/hidden_dim/multi_variable_model_results/', name))
...
result.to_csv("data/hidden_dim_seq2seq_random_search_result.csv")

print("Trianing done! model saved at data/hidden_dim_seq2seq_random_search_result.csv")
